    ...
    return (
        <div className={`flex flex-col w-[28rem] gap-8 items-center box-border ${darkMode ? '' : 'text-white'}`}>
            ...
            <div className='w-full flex flex-row gap-3'>
                ...
                <div className={`relative w-[50%] border rounded-[5px] flex flex-col justify-center items-center text-center px-5 py-7 gap-4 border-[#14B8A6] ${selected === 'team' ? 'bg-[#14B8A6] text-white': 'bg-transparent'}`} onClick={()=> setSelected('team')}>
                ...
                <div className={`relative w-[50%] border rounded-[5px] flex flex-col justify-center text-center items-center px-5 py-7 gap-4 border-[#14B8A6] ${selected === 'personal' ? 'bg-[#14B8A6] text-white': 'bg-transparent'}`} onClick={()=> setSelected('personal')}>
