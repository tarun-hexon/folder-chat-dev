...
const SideBar = () => {
    ...
    return (
        <div className='w-full bg-[#EFF5F5] flex flex-col py-[19px] px-[18px] gap-5 font-Inter min-h-screen'>
            ...
            {/* <div className='flex gap-2 hover:cursor-pointer bg-[#DEEAEA] items-center justify-between p-2 rounded-md'>
                <div className='flex gap-2 items-center'>
                    <Image src={Danswer} alt={'danswer'} className='w-4 h-4' />
                    <span className='font-[600] text-sm leading-5'>Danswer</span>
                </div>
                <Image src={rightArrow} alt={'open'} className='w-4 h-4' />
            </div> */}
