...
return (
  <div className={`flex font-Inter justify-center items-center w-full h-screen box-border bg-[#115E59] flex-col gap-10 text-white text-4xl ${darkMode ? 'bg-[#EFF5F5] text-black' : 'bg-[#115E59]'}`}>
    ...
    {userSession && <Button className='absolute float-right top-5 right-16 bg-[#14B8A6] border-[#14B8A6] leading-[24px] hover:bg-[#EFF5F5] hover:text-[#14B8A6]' onClick={signOut}>Log Out</Button>}
